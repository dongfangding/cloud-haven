...
public class OpenFeignAppendHeaderInterceptor implements RequestInterceptor {
    ...
    public void apply(RequestTemplate template) {
        ...
        template.header(RequestHeaderEnum.SIM_OPERATOR.getName(), requestContext.getSimOperator());
        ...
        template.header(RequestHeaderEnum.OA_ID.getName(), requestContext.getOaId());
